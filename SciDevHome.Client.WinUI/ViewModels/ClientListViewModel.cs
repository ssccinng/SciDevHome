...
public partial class ClientListViewModel : ObservableRecipient, INavigationAware
{
    ...
    public ClientListViewModel(INavigationService navigationService, ISampleDataService sampleDataService)
    {
    ...
    private void OnItemClick(SampleOrder? clickedItem)
    {
        if (clickedItem != null)
        {
            ...
            _navigationService.NavigateTo(typeof(ClientListDetailViewModel).FullName!, clickedItem.OrderID);
        }
    }
}
